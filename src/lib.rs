...
pub const CS_OPT_SYNTAX_DEFAULT: Enum_cs_opt_value = Enum_cs_opt_value::CS_OPT_OFF;
pub const CS_OPT_SYNTAX_NOREGNAME: Enum_cs_opt_value = Enum_cs_opt_value::CS_OPT_ON;
#[derive(Copy, Clone)]
#[repr(u32)]
...
pub struct Struct_cs_arm_op {
    ...
    pub shift: Struct_Unnamed1,
    pub _type: arm_op_type,
    pub _bindgen_data_1_: [u64; 2usize],
    pub subtracted: u8,
}
impl Struct_cs_arm_op {
    pub unsafe fn reg(&mut self) -> *mut c_uint {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn imm(&mut self) -> *mut i32 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn fp(&mut self) -> *mut c_double {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
...
impl Struct_cs_arm64_op {
    ...
    pub unsafe fn imm(&mut self) -> *mut i64 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn fp(&mut self) -> *mut c_double {
    ...
    pub unsafe fn sys(&mut self) -> *mut c_uint {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
