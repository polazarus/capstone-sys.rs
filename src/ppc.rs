...
impl ::std::default::Default for ppc_op_mem {
    fn default() -> Self {
...
impl ::std::default::Default for ppc_op_crx {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
...
impl ::std::default::Default for cs_ppc_op {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
...
impl ::std::default::Default for cs_ppc {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
